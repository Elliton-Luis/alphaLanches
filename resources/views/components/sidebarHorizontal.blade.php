<div class="d-block d-md-none container-fluid mb-2 text-bg-dark">
    <nav class="navbar py-2">
        <div class="container-fluid d-flex justify-content-between align-items-center">
            ...
            <!-- Botão Menu -->
            <div class="dropdown">
                <button class="btn btn-dark border-0 shadow-sm" type="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <!-- Logo ou Título -->
            <a href="{{ route('home') }}" class="text-white text-decoration-none fs-4 fw-bold"><img src="{{ asset('images/AlphaLanches-Logo.png') }}" height="78px" alt="Logo Alpha"></a>
        </div>
    </nav>
</div>
