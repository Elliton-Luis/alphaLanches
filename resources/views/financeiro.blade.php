...
@section('content')
  ...
  <div class="container my-5">
    ...
    <button class="btn btn-outline-primary rounded-pill px-4" type="button" data-bs-toggle="collapse"
      data-bs-target="#cardsFinanceiro" aria-expanded="false" aria-controls="cardsFinanceiro" id="btnToggleResumo">
    ...
    <a href="{{ route('relatorio') }}" class="btn btn-primary" target="_blank">
      <i class="bi bi-file-earmark-pdf"></i> Exportar Relatório de Vendas (PDF)
    </a>
