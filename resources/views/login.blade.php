    ...
    <div class="card p-4 shadow">
        ...
        <form action="{{ route('login.auth') }}" method="POST">
            ...
            <div class="mb-3 position-relative">
                ...
                <input type="password" class="form-control form-control-lg ps-5 pe-5" name="password" id="password" placeholder="Digite sua senha" required maxlength="20">
        ...
        <div class="text-center mt-3">
            <a href="{{ route('login.cadastro') }}" class="text-decoration-none">Cadastre-se</a>
        </div>
    </div>
